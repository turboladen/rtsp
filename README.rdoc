...
The uber-quick get started:
  ...
  rtsp_client = RTSP::Client.new "192.168.1.10/stream1"
  rtsp_client.options
  rtsp_client.describe

  rtsp_client.aggregate_control_track  # => "rtsp://192.168.1.10:554/stream1/"
  rtsp_client.media_control_tracks     # => ["rtsp://192.168.1.10:554/stream1/track1"]
